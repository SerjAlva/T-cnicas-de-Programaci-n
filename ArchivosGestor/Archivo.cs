...
namespace ArchivosGestor
{
    public class Archivo
    {
        ...
        //ahora borraremos algunas cosas de ahí
        public void BorrarAleatorio( string Archivo)
        {
            try
            //byte[] dataArray = new byte[100000];
             {  
                Random aleatorio = new Random();
                fs = new FileStream(@Archivo, FileMode.Open, FileAccess.Write);//leer el flujo 
                fs.Seek(10, SeekOrigin.Begin); //te psiciona donde quieras
